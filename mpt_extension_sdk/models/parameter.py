...
class ParameterValue(BaseModel):
    ...
    display_value: str | None = Field(
        default=None, serialization_alias="displayValue", validation_alias="displayValue"
    )
...
class ParameterBag(BaseModel):  # noqa: WPS214
            ...
            lambda parameter: parameter.model_copy(
                update={
                    ...
                    "constraints": parameter.constraints.model_copy(
                        update={"hidden": False, "required": True}
                    ),
                }
            ),
        )
    ...
    def _with_parameter(
        ...
        external_id: str,
        phase: str,
        updater: Callable[[ParameterValue], ParameterValue],
        ...
        if not is_updated:
            updated_parameters.append(
                default_parameter or updater(ParameterValue(external_id=external_id))
            )
    ...
    def _with_value(self, external_id: str, new_value: Any, phase: str) -> Self:
        ...
        return self._with_parameter(
            ...
            default_parameter=ParameterValue(external_id=external_id, value=new_value),
        )
