...
def test_initialize(
    mocker, mock_initializer_options, mock_app_group_name, mock_json_ext_variables
):
    mocked_setup = mocker.patch("django.setup")
    initialize(
        mock_initializer_options,
        group=mock_app_group_name,
        json_variables=mock_json_ext_variables,
    )
...
def test_initialize_default_ext_variables(
    mocker, mock_initializer_options, mock_app_group_name
):
    mocked_setup = mocker.patch("django.setup")
